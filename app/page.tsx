...
function LinkCard({
  ...
  return(
    <a href={url} className="flex items-center p-4 w-full rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 bg-gray-100 mb-3 max-w-3xl">
      <div className="flex w-full text-center">
        ...
        <h2 className="flex justify-center items-center font-semibold w-full text-gray-800">{title}</h2>
      </div>
    </a>
  )
}
